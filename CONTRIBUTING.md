# Contributing to KitoWalletCards
...
3. Make your change. Follow
   [KitoWalletCards's engineering standards](https://github.com/WykSofts-Inc/KitoWalletCards/blob/main/docs/ENGINEERING_STANDARDS.md) —
